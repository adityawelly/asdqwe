...
class EmployeeDinasExport implements FromCollection, WithHeadings, ShouldAutoSize, WithMapping
{
    use Exportable;
    private $params;
    ...
    */
    ...
    {
        $data = EmployeeDinas::with('employee.company_region','employee.grade_title','employee.department');
