    ...
    <div class="page-inner">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('employee-dinas.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="">Tujuan<span class="required-label">*</span></label>
				...
				<div class="col-md-12">
                    <div class="alert alert-primary">
                        <label class="text-primary"><i class="fas fa-lightbulb"></i> Good to know !</label>
                            <br>
                            1. Dinas Luar sehari penuh <br> 
								Isikan jam Masuk & Jam pulang sesuai jam kerja Anda.<br> 
								Contoh : Mulai 08:00 dan Akhir 17:00.<br> 
							2. Dinas Luar Setengah Hari.<br> 
								- Datang ke kantor lalu pergi dinas, isikan jam mulai dengan jam pergi dinas,<br>
								  Contoh : Mulai 13:00 dan Akhir 17:00<br>
								- Pergi dinas lalu datang ke kantor, isikan jam mulai dengan jam pergi dinas,<br> 
								  dan jam akhir dengan jam anda tiba di kantor<br>								
								  Contoh : Mulai 08:00 dan Akhir 12:00
                        </div>
                </div>
            </div>
			    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List Izin Dinas Luar Anda</h4>
                            </div>
                        <div class="card-body">
