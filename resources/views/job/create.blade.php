                            ...
                            <div class="row">
                                <div class="col-md-6">
								   <div class="form-group">
                                        <label for="">PTK No<span class="required-label">*</span></label>
                                        <select name="ptk_id" class="form-control selectpicker" required>
                                            <option value=""></option>
											<option value="0">Internal Memo</option>
                                            @foreach ($ptkno as $item)
                                                <option value="{{ $item->ReqId }}">{{ $item->ReqNo }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
