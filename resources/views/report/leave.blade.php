...
<div class="content animated fadeIn">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Laporan Ketidakhadiran</h4>
            {{ Breadcrumbs::render('report-leave') }}
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-primary">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">Filter Ketidakhadiran</h4>
                        ...
                        <form action="" id="filterForm">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="">Tipe Ketidakhadiran</label>
                                        <select name="leave_type" class="form-control selectpicker" style="width: 100%">
                                            <option value="all" selected>Semua</option>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            @endcan
                            @can('import-report-leave')
                                <a class="btn btn-sm btn-warning btn-round ml-2" href="{{ asset('uploads/excel/template-2019.xlsx') }}">
                                    <i class="fas fa-cloud-download-alt"></i> Unduh Template Leave
                                </a>
                                <button class="btn btn-sm btn-secondary btn-round ml-2" data-toggle="modal" data-target="#pageModal">
                                    <i class="fas fa-file-import"></i> Import Leave
                                </button>
                            @endcan
                        </div>
                    </div>
                            ...
                            <table id="report-leave-table" class="display table table-head-bg-primary">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="content no-sort no-search">Jam Berakhir</th>
                                        <th class="content no-sort no-search">Keterangan</th>
                                        <th class="content no-sort no-search">Durasi</th>
                                        <th class="content no-sort no-search">Minus Tahunan ?</th>
                                        <th class="content no-sort no-search">Cuti Extend ?</th>
										<th class="content no-sort no-search">Cuti Opname ?</th>
...
<script>
    ...
    var dt = $('#report-leave-table').dataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: '{{ route('report.leave') }}',
            type: 'POST',
            dataType: 'JSON',
            data: function(d){
                d.employee_no = filterForm.find('select[name=employee_no]').val();
                d.leave_type = filterForm.find('select[name=leave_type]').val();
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('report.leave.import') }}" method="post" id="formModal" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="exportModalTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('report.leave.do_export') }}" method="post" id="exportFormModal">
                        @csrf
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="">Tanggal Mulai Cuti/Izin <span class="required-label">*</span></label>
                            <input type="text" class="form-control datepicker" name="start_date" required placeholder="Pilih Tanggal">
                        </div>
                        <div class="form-group">
                            <label for="">Tanggal Akhir Cuti/Izin <span class="required-label">*</span></label>
                            <input type="text" class="form-control datepicker" name="end_date" required placeholder="Pilih Tanggal">
                        </div>
                        <div class="form-group">
