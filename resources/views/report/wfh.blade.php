...
<div class="content animated fadeIn">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Rekap Pengajuan Kerja Dari Rumah</h4>
            {{ Breadcrumbs::render('report-wfh') }}
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="report-wfh-table" class="display table table-head-bg-primary">
                                <thead>
                                    <tr>
...
<script>
    ...
    var dt = $('#report-wfh-table').dataTable({
        "serverSide": true,
        "processing": true,
        "autoWidth": true,
        "stateSave": true,
    ...
    function delete_wfh(id) {
        if (confirm('Apakah anda yakin ?')) {
            $.ajax({
                url: '{{ route('report.delete_wfh') }}',
                type: 'POST',
                dataType: 'JSON',
                data: {
                    'id':id
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('report.wfh.do_wfh_export') }}" method="post" id="exportFormModal">
                        @csrf
                        <div class="form-group">
