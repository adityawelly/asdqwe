...
<div class="content animated fadeIn">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Rekap Pengajuan Izin Dinas Luar</h4>
            {{ Breadcrumbs::render('report-dinas') }}
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="report-dinas-table" class="display table table-head-bg-primary">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="content no-sort no-search">Total</th>
...
<script>
    ...
    var dt = $('#report-dinas-table').dataTable({
        "serverSide": true,
        "processing": true,
        "autoWidth": true,
        "stateSave": true,
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('report.dinas.do_dinas_export') }}" method="post" id="exportFormModal">
                        @csrf
                        <div class="form-group">
