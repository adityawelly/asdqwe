...
<div class="content animated fadeIn">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Rekap Pengajuan Isolasi Mandiri</h4>
            {{ Breadcrumbs::render('report-isoman') }}
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="report-isoman-table" class="display table table-head-bg-primary">
                                <thead>
                                    <tr>
...
<script>
    ...
    var dt = $('#report-isoman-table').dataTable({
        "serverSide": true,
        "processing": true,
        "autoWidth": true,
        "stateSave": true,
    ...
    function delete_isoman(id) {
        if (confirm('Apakah anda yakin ?')) {
            $.ajax({
                url: '{{ route('report.delete_isoman') }}',
                type: 'POST',
                dataType: 'JSON',
                data: {
                    'id':id
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('report.isoman.do_isoman_export') }}" method="post" id="exportFormModal">
                        @csrf
                        <div class="form-group">
