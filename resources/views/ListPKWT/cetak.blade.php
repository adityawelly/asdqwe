...
<head>
    ...
    <title>{{ $xx->pkwt_no .'-'. $xx->fullname }}</title>
	@endforeach
                ...
                <div class="card">				
                    <div class="card-body">
                        <div class="row">						
							...
							<tr>
							<td valign="top"  colspan="3">Bahwa PIHAK KEDUA sepakat dan tidak berkeberatan untuk menerima maksud dan kehendak PIHAK PERTAMA 
							untuk mempekerjakan PIHAK KEDUA pada perusahaan PIHAK PERTAMA untuk jangka waktu tertentu.</td>	
							</tr>
							<tr>
							<td valign="top"  colspan="3">Berdasarkan hal-hal sebagaimana diuraikan diatas, maka PARA PIHAK sepakat dan tidak berkeberatan untuk membuat dan menandatangani Perjanjian ini 
							dengan syarat dan ketentuan-ketentuan sebagai berikut:</td>	
							</tr>
							</table><br>
							...
							<td valign="top" width="97%" >Bahwa jangka waktu Perjanjian ini berlaku selama <b>{{ $xx->bulan }}</b> Bulan, terhitung mulai:</td>
							</tr>
							<tr>
                    ...
                    <table width="100%">
						<tr>
						<td align="left" width="35%">PIHAK PERTAMA</td>
